...
import org.egov.infra.persist.web.contract.ServiceMaps;
...
public class EgovPersistApplication {
    ...
    public static void main(String[] args) throws JsonProcessingException {
    	ObjectMapper objectMapper = new ObjectMapper();
    	 ...
    	 ServiceMaps maps=new ServiceMaps();
    	 maps.setServiceName("satish");
    	 List<Mapping> list=new ArrayList<>();
    	 Mapping mapp=new Mapping();
    	 mapp.setDescription("test");
    	 mapp.setVersion("1");
    	 mapp.setName("sai");
  list.add(mapp);
    	 maps.setMappings(list);
    	 service.setServiceMaps(maps);
